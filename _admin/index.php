...
?>
  ...
  <head>
    ...
    <link rel="shortcut icon" href="../images/OZAN_1.png">
  ...
  <body>
    ...
    <aside id="left-panel" class="left-panel" style="font-family: sans-serif;">
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Admin EL-BAYAN</a>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse" style="font-family: sans-serif;">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active">
              <a href="?page="> <i class="menu-icon fa fa-home" style="font-size: 23px;color: #ffff00;"></i>Dashboard </a>
            </li>
            <li class="menu-item-has-children dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-gears" style="font-size: 23px;color: #ffff00;"></i> Data Master</a>
              <ul class="sub-menu children dropdown-menu">
                <li>
                  <i class="menu-icon fa fa-folder-open-o" style="font-size: 20px;color: #0000FF ;"></i><a href="?page=v_mapel"> Mata Pelajaran</a>
                </li>
                <li>
                  <i class="menu-icon fa fa-folder-open-o" style="font-size: 20px;color:#0000FF ;"></i><a href="?page=v_tajaran"> Tahun Ajaran</a>
                </li>
                <li>
                  <i class="menu-icon fa fa-folder-open-o" style="font-size: 20px;color:#0000FF ;"></i><a href="?page=v_kejur"> Kelas / Jurusan</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="?page=v_guru"> <i class="menu-icon fa fa-folder-o" style="font-size: 23px;color:#ffff00 ;"></i> Manage Data pengajar</a>
            </li>
            <li>
              <a href="?page=v_agenda"> <i class="menu-icon fa fa-folder-o" style="font-size: 23px;color:#ffff00;"></i> History Agenda </a>
            </li>
            <li>
              <a href="?page=v_file"> <i class="menu-icon fa fa-file-text-o" style="font-size: 23px;color:#ffff00;"></i> File Perangkat </a>
            </li>

            <li>
              <a href="?page=v_lapid"> <i class="menu-icon fa fa-calendar" style="font-size: 23px;color:#ffff00 ;"></i>Bank Data Agenda </a>
            </li>
            <li>
              <a href="?page=v_user"> <i class="menu-icon fa fa-user-md" style="font-size: 23px;color:#ffff00 ;"></i> Manage User </a>
            </li>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <!-- Header-->
      <header id="header" class="header" style="background-color: #FFA500 ;">
                 ...
                 <button class="search-trigger"><i class="fa fa-search"></i></button>
                        <div class="form-inline">
                            <form class="search-form">
                                <input class="form-control mr-sm-2" type="text" placeholder="Search ..." aria-label="Search" style="border: solid 2px;">
        ...
        <div class="col-sm-4">
          <div class="page-header float-left">
            <div class="page-title">
              <h1> <span class="fa fa-home"></span> Halaman Admin El-Bayan</h1>
            </div>
          </div>
        </div>
        <div class="col-sm-8">
          <div class="page-header float-right">
            <div class="page-title">
              <ol class="breadcrumb text-right">
                <li class="active">Selamat Datang ..<b style="color: Orange;"><?php echo $data['nama']; ?></b> </li>
                <li class="active">
