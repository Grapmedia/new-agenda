...
<head>
  ...
  <meta name="Josh Ajeh" content="Aplikasi E-Jurnal Guru ANNKS">
...
<body class="bg-dark" style="background-image: url(images/bgbgb.png);">


  <div class="sufee-login d-flex align-content-center flex-wrap">
    <div class="container">
      <!-- style="background-image: url(images/materi.jpg); border-radius: 20px;  -->

      <div class="login-content" style="background-color:rgba(0,0,0,0.6); border-radius: 20px; ">
        <div class="login-logo">
          <br>
          <center>
            <img src="images/lg.png" width="130" style="border-radius:100%;">
          </center>
          <h2 style="color: #fff;">Jurnal Harian Pengajar</h2>
          <br> <b style="color: #fff;">Pondok Pesantren El-Bayan</b>
          <p style="color: #fff;">Kolompok 6 Kerja Praktek STMIK Komputama</p>
        </div>
