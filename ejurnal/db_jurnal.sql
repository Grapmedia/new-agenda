...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jul 2018 pada 12.46
...
(26, 1, 20, '2018-05-23', '22:01', '<p>tes ajo woi</p>\r\n', 'pas bna ko', 'ketttttttt', ''),
...
(1, 'Kepala Sekolah', 'kepsek', 'kepsek', 'userk.png');
...
--
ALTER TABLE `tb_agenda`
  MODIFY `id_agenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT untuk tabel `tb_agendalain`
--
ALTER TABLE `tb_agendalain`
  MODIFY `id_lain` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
