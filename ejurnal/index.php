...
<head>
    ...
    <title>Aplikasi E-Jurnal Guru</title>
...
<body class="bg-dark" style="background-image: url(images/smk.jpg);">
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            ...
            <div class="login-content" style="background-image: url(images/bg.jpg); border-radius: 20px; ">
                <div class="login-logo">
                  <br>
                  <center>
<img src="images/logo.jpg" width="150" style="border-radius:100%;">
</center>
                    <h2>Aplikasi E-Jurnal</h2>
                    <br> <b>SMKN 4 PAYAKUMBUH</b>
                </div>
                <div class="login-form">
                  <b>Login Aplikasi</b>                   
                    ...
                    <form method="post" action="">
                        ...
                        <input type="submit" name="login" class="btn btn-primary btn-flat m-b-30 m-t-30" value="Login" style="border-radius: 20px;background-color:#40c4ff;">
